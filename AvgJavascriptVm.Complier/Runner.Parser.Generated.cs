...
// Input file <Runner.Language.grammar.y - 8/30/2017 7:00:44 PM>
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "array", "statement_or_semicolon", "arguments_list", "function_body", "expression_or_empty", 
      "variable_declaration_identifier", "array_list", };

  static RunnerParser() {
    states[0] = new State(new int[]{18,7,7,13,8,20,9,42,5,52,10,60,11,71,24,27,23,28,25,29,12,31,13,32,21,34,4,79,3,-3},new int[]{-1,1,-3,3,-4,89,-5,5,-8,6,-9,12,-10,19,-11,41,-12,51,-13,59,-14,64,-15,73,-16,30,-17,33,-6,78});
    states[1] = new State(new int[]{3,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{18,7,7,13,8,20,9,42,5,52,10,60,11,71,24,27,23,28,25,29,12,31,13,32,21,34,4,79,3,-2},new int[]{-4,4,-5,5,-8,6,-9,12,-10,19,-11,41,-12,51,-13,59,-14,64,-15,73,-16,30,-17,33,-6,78});
    states[4] = new State(-5);
    states[5] = new State(-6);
    states[6] = new State(-10);
    states[7] = new State(new int[]{19,8,18,7,7,13,8,20,9,42,5,52,10,60,11,71,24,27,23,28,25,29,12,31,13,32,21,34},new int[]{-7,9,-5,77,-8,6,-9,12,-10,19,-11,41,-12,51,-13,59,-14,64,-15,73,-16,30,-17,33});
    states[8] = new State(-23);
    states[9] = new State(new int[]{19,10,18,7,7,13,8,20,9,42,5,52,10,60,11,71,24,27,23,28,25,29,12,31,13,32,21,34},new int[]{-5,11,-8,6,-9,12,-10,19,-11,41,-12,51,-13,59,-14,64,-15,73,-16,30,-17,33});
    ...
    states[43] = new State(new int[]{24,27,23,28,25,29,12,31,13,32,21,34,14,-39},new int[]{-21,44,-15,76,-16,30,-17,33});
    states[44] = new State(new int[]{14,45});
    states[45] = new State(new int[]{24,27,23,28,25,29,12,31,13,32,21,34,14,-39},new int[]{-21,46,-15,76,-16,30,-17,33});
    states[46] = new State(new int[]{14,47});
    states[47] = new State(new int[]{24,27,23,28,25,29,12,31,13,32,21,34,17,-39},new int[]{-21,48,-15,76,-16,30,-17,33});
    ...
    states[56] = new State(new int[]{6,57,18,-40,7,-40,8,-40,9,-40,5,-40,10,-40,11,-40,24,-40,23,-40,25,-40,12,-40,13,-40,21,-40,4,-40,3,-40,19,-40});
    ...
    states[68] = new State(new int[]{20,69,14,-44,15,-44});
    ...
    states[79] = new State(new int[]{24,80});
    states[80] = new State(new int[]{16,81});
    states[81] = new State(new int[]{24,92,17,-34,15,-34},new int[]{-19,82});
    states[82] = new State(new int[]{17,83,15,90});
    states[83] = new State(new int[]{18,85},new int[]{-20,84});
    states[84] = new State(-27);
    states[85] = new State(new int[]{19,86,18,7,7,13,8,20,9,42,5,52,10,60,11,71,24,27,23,28,25,29,12,31,13,32,21,34,4,79},new int[]{-3,87,-4,89,-5,5,-8,6,-9,12,-10,19,-11,41,-12,51,-13,59,-14,64,-15,73,-16,30,-17,33,-6,78});
    states[86] = new State(-28);
    states[87] = new State(new int[]{19,88,18,7,7,13,8,20,9,42,5,52,10,60,11,71,24,27,23,28,25,29,12,31,13,32,21,34,4,79},new int[]{-4,4,-5,5,-8,6,-9,12,-10,19,-11,41,-12,51,-13,59,-14,64,-15,73,-16,30,-17,33,-6,78});
    states[88] = new State(-29);
    states[89] = new State(-4);
    states[90] = new State(new int[]{24,91});
    ...
    rules[26] = new Rule(-18, new int[]{14});
    rules[27] = new Rule(-6, new int[]{4,24,16,-19,17,-20});
    rules[28] = new Rule(-20, new int[]{18,19});
    rules[29] = new Rule(-20, new int[]{18,-3,19});
    rules[30] = new Rule(-13, new int[]{10,14});
    rules[31] = new Rule(-13, new int[]{10,-15,14});
    rules[32] = new Rule(-19, new int[]{24});
    rules[33] = new Rule(-19, new int[]{-19,15,24});
    rules[34] = new Rule(-19, new int[]{});
    rules[35] = new Rule(-9, new int[]{7,16,-15,17,-18});
    rules[36] = new Rule(-10, new int[]{8,-8,7,16,-15,17,14});
    rules[37] = new Rule(-11, new int[]{9,16,-21,14,-21,14,-21,17,-18});
    rules[38] = new Rule(-21, new int[]{-15});
    rules[39] = new Rule(-21, new int[]{});
    rules[40] = new Rule(-12, new int[]{5,16,-15,17,-18});
    rules[41] = new Rule(-12, new int[]{5,16,-15,17,-18,6,-18});
    rules[42] = new Rule(-14, new int[]{11,-22});
    rules[43] = new Rule(-14, new int[]{-14,15,-22});
    rules[44] = new Rule(-22, new int[]{24});
    rules[45] = new Rule(-22, new int[]{24,20,-15});
    rules[46] = new Rule(-16, new int[]{12});
    rules[47] = new Rule(-16, new int[]{13});
    rules[48] = new Rule(-17, new int[]{21,-23,22});
    rules[49] = new Rule(-17, new int[]{21,22});
    rules[50] = new Rule(-23, new int[]{-15});
    rules[51] = new Rule(-23, new int[]{-23,15,-15});
  }
...
{ CurrentSemanticValue.n = new BlockNode((StatementsNode)ValueStack[ValueStack.Depth-2].n); }
        break;
      case 25: // statement_or_semicolon -> statement
{ CurrentSemanticValue.n = ValueStack[ValueStack.Depth-1].n; }
        break;
      case 26: // statement_or_semicolon -> SEMICOLON
...
{ CurrentSemanticValue.n = new ArgumentsListNode(); }
        break;
      case 35: // while -> WHILE, LPARENTH, expression, RPARENTH, statement_or_semicolon
...
{ CurrentSemanticValue.n = ValueStack[ValueStack.Depth-1].n; }
        break;
      case 40: // if -> IF, LPARENTH, expression, RPARENTH, statement_or_semicolon
{ CurrentSemanticValue.n = new IfNode((ExpressionNode)ValueStack[ValueStack.Depth-3].n, (StatementNode)ValueStack[ValueStack.Depth-1].n); }
        break;
      case 41: // if -> IF, LPARENTH, expression, RPARENTH, statement_or_semicolon, ELSE, 
...
{ CurrentSemanticValue.n = new BooleanNode(false); }
        break;
      case 48: // array -> LBRACKET, array_list, RBRACKET
{ CurrentSemanticValue.n = ValueStack[ValueStack.Depth-2].n; }
        break;
      case 49: // array -> LBRACKET, RBRACKET
{ CurrentSemanticValue.n = new ArrayNode(); }
        break;
      case 50: // array_list -> expression
{ var arr = new ArrayNode(); arr.Values.Add((ExpressionNode)ValueStack[ValueStack.Depth-1].n); CurrentSemanticValue.n = arr; }
        break;
      case 51: // array_list -> array_list, COMMA, expression
